    ...
    return Container(
      ...
      child:
        ...
        Column(
          ...
          children: <Widget>[
            TitleText(
                text: isHomePageSelected ? 'Our' : 'Shoping',
                fontSize: 27,
        ...
        Spacer(),
        !isHomePageSelected
            ? Icon(Icons.delete_outline, color: LightColor.orange)
            : SizedBox()
      ]),
    );
  }

  void onBottomIconPress(int index) {
    if (index == 0 || index == 1) {
      setState(() {
    ...
    return Scaffold(
      ...
      Positioned(
          ...
          child: CustomBottomNavigationBar(
            onIconPressedCallback: onBottomIconPress,
          ))
    ])));
  }
}
